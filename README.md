...
- HTML5 (semântico)  
- CSS3 (planejado para etapas posteriores)  
- JavaScript (planejado para implementação futura)  

## Próximos Passos
- Implementar interatividade com JavaScript (formulário e mapa).  
- Desenvolver estilo visual com CSS responsivo.  
- Simular persistência de dados utilizando LocalStorage.  
- Criar novas páginas individuais para representar mais exemplos de comércios.  
